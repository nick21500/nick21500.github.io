...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"stack",prev:"",next:"",duration:18*100,delay:51*100,width:640,height:230,autoPlay:true,autoPlayVideo:false,playPause:true,stopOnHover:true,loop:false,bullets:0,caption:true,captionEffect:"move",controls:true,responsive:1,fullScreen:false,onBeforeStep:0,images:0});

function updateLinkText() {
	var linkText = $('.ws-title div').html();
	$('#slider_link').html(linkText);
}

$(document).ready(function() {
	updateLinkText();
	setInterval(updateLinkText, 7100);
});